...
# firewall_subset2 <- firewall_subset %>% filter(`Destination port` != 80 | `Destination port` != 53)
# firewall_subset2 %>% group_by(`Source port`, `Destination port`) %>% summarise(n = n()) %>% arrange(desc(n))
